...
import { getUrlReputation, type UrlReputationResponse } from "@/lib/api";

export function UrlReputationView() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const result = await getUrlReputation(url);
    ...
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      {notFound && !loading && (
        ...
        >
          ...
          <p>
            <strong>&quot;{url}&quot;</strong>에 대한 평판 정보가 아직 등록되지
            않았습니다.
          </p>
